...
// export default function Description({ onJoinClick }) {
//   useEffect(() => {
...
// bg-gradient-to-r from-[#f9e0ae] via-[#f7b267] to-[#d864a9] bg-clip-text text-transparent animate-gradient duration-1000 p-3"
//           data-aos="fade-down"
//         >
...
//  rounded-2xl p-6 text-center shadow-lg hover:scale-105 transition-transform duration-400 hover:shadow-pink-500/30 font-lora"
//               data-aos="zoom-in"
