...
//     // Simple check (replace with backend call)
...
//           <Link
//             to="/adminsignup"
//             className="text-pink-500 hover:underline font-baskerville"
//           >
//             Sign Up
//           </Link>
//         </p>
    ...
    <div className="min-h-screen flex items-center justify-center bg-[#0D0B1F] px-4 font-sans">
      ...
      >
        ...
        <input
          ...
          value={formData.email}
          onChange={handleChange}
          className="w-full mb-4 px-4 py-2 rounded font-baskerville bg-gray-700 text-white outline-none focus:ring-2 focus:ring-pink-500"
          required
        />
        ...
        <input
          ...
          value={formData.password}
          onChange={handleChange}
          className="w-full mb-6 px-4 py-2 rounded  bg-gray-700 text-white outline-none focus:ring-2 focus:ring-pink-500"
          required
        />

        <button
          type="submit"
          className="w-full  bg-gradient-to-r from-[#f9e0ae] via-[#f7b267] to-[#d864a9] text-black py-2 font-baskerville rounded transition " 
        >
          Login
        </button>
